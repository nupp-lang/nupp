...
explicit `unsafe do` blocks. See [docs/ownership.md](docs/ownership.md). Its
[trace-aware checker](docs/tooling/jit-trace-checking.md) finds deterministic
LuaJIT recorder blockers in checked source and exact generated bytecode,
transports `@jit` contracts through resolved calls, and normalizes aborts
observed in a run.
