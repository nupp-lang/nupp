...
- **P0 Self-hosting.** Compiler sources are `src/nupp/compiler/*.nupp` (nothing
  else); generated artifacts live in the gitignored `build/nupp/compiler/`;
