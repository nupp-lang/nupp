...
The core landed: `nupp.mem.sharedbytes.Region`, an engine-owned
...
Transferable owned buffers landed: a worker parameter may take a `nupp.mem.heap` array of a
...
The two blocking specification gaps landed. A builder lends a
