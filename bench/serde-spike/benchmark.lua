...
local json = require("simdjson_bench_native")
...
local cases = {
   ...
   { group = "constantFusionCeiling", name = "ordinaryRecord", call = "preparedEncodeMedium", result = "#value", baseline = true },
   { group = "constantFusionCeiling", name = "constantRecord", call = "preparedEncodeConstantMedium", result = "#value" },
...
if jsonOutput then
   ...
   local order = {
      ...
      "encodeSmall", "prepareAndEncodeSmall", "encodeMedium", "constantFusionCeiling",
      "encodePayload4KiB", "encodePayload64KiB", "encodeNested",
