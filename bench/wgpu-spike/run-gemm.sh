#!/bin/sh
# Naive f32 GEMM through the generated multi-buffer GPU binding, validated
# element-exact against the ordinary CPU body of the same source.
set -eu
...
exec "$LUAJIT" "$BENCH/gemm-api.lua"
