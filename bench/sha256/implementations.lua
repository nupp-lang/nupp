...
implementations.aot = require("nupp.bench.sha256").sha256

--- The same Nupp source built by the `sha256-scalar` target, left to LuaJIT.
implementations.scalar = assert(
    loadfile("build/scalar/nupp/digest/internal/sha256.lua"),
    "build the sha256-scalar target first"
)().sha256

--- The C that was the old public SHA-256, retained only as a control.
...
implementations.titles = {aot = "Nupp @aot", scalar = "Nupp on LuaJIT", c = "C (bootstrap)", legacy = "Lua bit ops",}
