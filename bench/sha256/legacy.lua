-- The implementation `nupp.compiler.build.hash` carried before `nupp.data.digest`
-- replaced it: SHA-256 over LuaJIT's `bit` library, with the message padded by
-- concatenation and the schedule in an ordinary Lua table.
--
