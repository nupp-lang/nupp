...
-- `ffi.new`. Measured against the gate in plans/014-optimizations.md -- a gain with
...
-- `expect` is what plans/014-optimizations.md records about each, and what this run
...
if #stale > 0 then
   ...
   io.write(" plans/014-optimizations.md wants rereading before anything is built\n\n")
   os.exit(1)
end
