...
docs = "docs/reference.md#fixed-width-scalar-arithmetic" ,
} ,
{
code = "NUPP2012" ,
...
docs = "docs/derives.md#comptime-providers" ,
} ,
{
code = "NUPP2810" ,
...
docs = "docs/reference.md#allocation-and-raising-regions" ,
}
...
entry . wrong ,  right =
entry . right ,  strict =
entry . strict and true or false ,  related =
entry . related or { } ,  docs =
entry . docs ,  family =
false }, explain.Entry)
...
return setmetatable({ code =
code ,  summary =
lint and lint . summary or family . summary ,  rule =
lint and (
"A lint, reported at "
.. lint . level
.. " by default and configurable by name or by category. "
.. family . rule
) or family . rule ,  wrong =
nil ,  right =
nil ,  strict =
false ,  related =
{ } ,  docs =
...
function explain . familyTitle ( code )
local family = familyFor ( code )
