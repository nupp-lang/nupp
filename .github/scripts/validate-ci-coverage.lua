...
local root = (arg and type(arg[0]) == "string" and arg[0] or ""):match("^(.*)[/\\]%.github[/\\]") or "."
...
--- behind a subprocess and a PATH lookup.
function validator.problems()
    local problems = {}
    ...
    return problems, #jobOrder
end

local invokedDirectly = arg ~= nil and type(arg[0]) == "string"
    and arg[0]:match("validate%-ci%-coverage%.lua$") ~= nil
