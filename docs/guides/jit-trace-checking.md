...
[editors.md](editors.md#visual-studio-code) for the extension that supplies it.
...
[c-interop.md](../concepts/c-interop.md#jit-sensitive-c-boundaries) for the C
...
rather than an aborted trace. See [ahead-of-time.md](ahead-of-time.md) for the
subset `@aot` admits and what it costs.

::: seealso
- [performance.md](performance.md) for the rewrites the compiler applies before
