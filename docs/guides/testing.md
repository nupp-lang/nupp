...
This is the standing check that a change to the compiler does not quietly change
its output. See [distribution](../reference/distribution.md) for the packaged
