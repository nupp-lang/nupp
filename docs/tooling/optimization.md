...
Use [LuaJIT trace checking](jit-trace-checking.md) to find recorder blockers in
source, exact generated bytecode, one editor-selected method, or an observed run.
