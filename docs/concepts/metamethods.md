...
[interfaces.md](../type-system/interfaces.md#is-is-a-claim-not-a-proof) for
...
uses [affine ownership](ownership.md) and automatic lexical cleanup instead.
...
::: seealso
- [interfaces.md](../type-system/interfaces.md#metamethod-contracts) for how a
  contract participates in interface satisfaction
- [generics.md](../type-system/generics.md#generic-metamethods) for the
  inference rules behind a generic contract
- [records.md](../type-system/records.md#names-hold-their-table) for the
