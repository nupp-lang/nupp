...
use. A task submitted through an [application task scope](tasks.md) inherits
...
[`nupp.runtime.backend.browser`](../guides/wasm-aot.md#browser-platform-backend),
...
Everything else is the same, [application task scopes](tasks.md) included:
