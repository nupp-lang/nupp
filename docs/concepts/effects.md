...
See [Performance](../guides/performance.md) for levels, remarks, pass controls,
...
values. See [ownership and affine
types](../type-system/ownership.md#public-capability-contracts) for the separate
