...
boundary. See [modules.md](modules.md) for how that boundary is declared.
...
See [ownership.md](ownership.md) for the resource workflow these annotations
join, and [the ownership
reference](../type-system/ownership.md#borrowing-and-pinning) for output
...
dependencies](../guides/build.md#c-dependencies) for the provider configuration.
...
ownership reference](../type-system/ownership.md#borrowing-and-pinning) for the
...
[the ownership reference](../type-system/ownership.md#c-interop) for the affine
