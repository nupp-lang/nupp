...
Usage:
  nupp aot [--emit ir|c|spirv|msl|asm|binding] [--check] [--function NAME] [--target TRIPLE] [--features TIER] <file>
...
Options:
  ...
  --json           Shorthand for --format json
  --text           Shorthand for --format text
  --emit ARTIFACT  Print one artifact: ir, c, spirv, msl, asm, or binding
