...
- [modules and project names](../concepts/declarations.md#diagnostics);
- [metamethods and contracts](../concepts/metamethods.md#diagnostics);
- [ownership and unsafe operations](../type-system/ownership.md);
...
See [switch expressions](../concepts/switch-expressions.md) for worked examples
and `nupp explain CODE` for an isolated failing and corrected program.
...
- [lsp.md](../guides/lsp.md): the same diagnostics in an editor.
