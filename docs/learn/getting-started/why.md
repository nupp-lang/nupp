...
typing](../language/gradual-typing.md#renaming-is-the-migration) for the four
...
structs](../language/types/records-and-structs.md#choosing) for which one a given type wants.
...
finalizer. [`nupp import-c`](../runtime/c-interop/index.md#import-a-header) writes a
...
[suspension handler](../runtime/concurrency/suspension.md#hosts-supply-scheduling-policy).
See [suspension](../runtime/concurrency/suspension.md) for the model from an application
...
LuaJIT it is usually the one that matters. See [tooling](../tooling/index.md) for the
...
passes](../performance/index.md#optimization-passes) for what each one
...
unsoundness](../language/types/index.md#deliberate-unsoundness) for what each
hole admits.
...
- [strictness.md](../language/gradual-typing.md) for how an existing `.lua` file
