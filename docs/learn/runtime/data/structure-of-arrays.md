...
passed through [C interop](../c-interop/index.md), or stored in either layout.
...
owner](../ownership/borrowing.md#declaring-affine-types) of one aligned
...
destruction](../ownership/borrowing.md#consumption-and-lexical-destruction).
...
Compile-time [reflection](../../language/reflection.md) publishes the semantic half of the
...
See [`OPT-6`](../../performance/index.md#opt-6-indexed-views) for how that proof
...
restart](../../projects/hot-reload.md#changes-that-require-restart) before existing
