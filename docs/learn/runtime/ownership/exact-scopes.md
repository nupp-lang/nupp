...
Ordinary [affine locals](index.md) are destroyed automatically at their
...
[SoA](../data/structure-of-arrays.md) and [span](nupp.mem.span) views, dropping only
...
[syntax.md](../../language/syntax.md#keywords-are-contextual) for the other contextual words.
...
[`nupp bc --check`](../../performance/jit-trace-checking.md) reports whether anything in
...
[structure-of-arrays.md](../data/structure-of-arrays.md#owners-and-row-views) for how
those views are acquired.

::: seealso
- [ownership.md](borrowing.md) for affine terminals, moves,
  aggregates, and unsafe representation boundaries
- [performance.md](../../performance/index.md#soa-columns) for what a hot loop
