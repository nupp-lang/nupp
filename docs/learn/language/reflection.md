...
reflection](../runtime/data/structure-of-arrays.md#layout-reflection) for what those report.
...
`nupp.reflect.extensionKey` creates a typed key with a provider; the first call builds
...
table](types/records-and-structs.md#names-hold-their-table) for how the two stand
