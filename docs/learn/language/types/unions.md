...
and a union of [records](records-and-structs.md) sharing a literal-typed field is a tagged
...
serializes through [](nupp.codec.json), compares field by field, prints readably,
...
A [switch expression](../switch-expressions.md) checks exhaustiveness
...
expressions](../switch-expressions.md#exhaustiveness-and-reachability)
...
types](comptime-types.md#inspection-and-construction) for the rest of
...
- [switch-expressions.md](../switch-expressions.md) for dispatching on
