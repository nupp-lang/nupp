...
[metamethods.md](../metamethods.md#supported-contracts) for the
...
[ownership](../../runtime/ownership/borrowing.md).
...
structs](records-and-structs.md#choosing) for which representation a type wants.
