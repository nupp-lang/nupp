...
[overview.md](index.md#gradual-escape-hatches) for what `any` gives up.
...
[overview.md](index.md#deliberate-unsoundness) for the other rules that
...
- [switch-expressions.md](../switch-expressions.md) for narrowing per
