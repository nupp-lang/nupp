...
types](../../runtime/ownership/affine-types.md) for what they generate. Bare `metatable` and the
...
say which pointers may be NULL. See [c-interop.md](../../runtime/c-interop/index.md)
...
::: seealso
- [overview.md](index.md#gradual-escape-hatches) for how `any` and `as`
  relate to the strict floor
- [records.md](records-and-structs.md) for the nominal types built out of these
