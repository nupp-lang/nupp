...
contracts](../metamethods.md). Method receiver specialization
...
Two [records](records-and-structs.md#records) have distinct nominal identities, so
...
system](index.md#strict-floor) for what does and does not survive to run
time.
