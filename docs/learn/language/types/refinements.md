...
structs](records-and-structs.md#records) for the identities those declarations get.
...
- [records.md](records-and-structs.md) for the nominal identity a record and a struct get
  instead
:::
