...
implementation honors it. See [c-interop.md](../runtime/c-interop/index.md) for the rest of what
...
reference. See
[ownership.md](../runtime/ownership/borrowing.md#public-capability-contracts) for the
...
of itself. See [suspension.md](../runtime/concurrency/suspension.md) for the guarantee that does travel
in a signature.
:::
...
see [performance.md](../performance/index.md#opt-2-numeric-ipairs) for the
...
the mechanism that describes it. See [ownership.md](../runtime/ownership/index.md) for the
...
- [performance.md](../performance/index.md) for the passes that consume a
  summary
:::
