...
Use one ordinary public span family in `nupp.mem.span` across LuaJIT and Lua
5.1. Shared I/O algorithms over target-compatible storage operations preserve
the Reader, Writer, Buffer and lease contracts without requiring foreign C
interoperability.
...
[NEP 20](0020-shared-immutable-byte-regions.md) and
[NEP 21](0021-transferable-owned-buffers.md).
