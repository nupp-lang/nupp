...
process timeouts and [task deadlines](0018-application-task-scopes.md) are
...
- Deciding what a deadline does when it expires.
  [NEP 18](0018-application-task-scopes.md) owns cancellation policy; this
...
reading. The policy moved to NEP 18 and left the reading behind.
