...
remaining hypothetical. The documentation's
[vectorization limits](../learn/performance/ahead-of-time/vectorization.md#vectorization-limits)
own where the edge currently sits.
