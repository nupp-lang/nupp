...
Reports: `NUPP2127`, `NUPP2128`, `NUPP2129`, `NUPP2134`, `NUPP2135`. `nupp explain <code>` says more.
...
Reports: `NUPP2801`, `NUPP2802`, `NUPP2803`, `NUPP2804`, `NUPP2805`, `NUPP2806`, `NUPP2807`, `NUPP2808`. `nupp explain <code>` says more.
...
| NUPP2128 | An associated type member cannot mean anything where it is written |
