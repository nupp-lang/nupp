...
results. This lowering applies to functions, callable records, methods,
constructors, and specialized calls with a statically known positional pack.
Safe calls guard the optional callee, receiver, and method before binding any
expanded argument path; their taken branch uses the same positional signature.
