...
// one (see src/nupp/tools/doc/html.nupp), from the embed's Open, or from a shared
...
function scheduleCheck() {
  ...
  // line; there's no incremental rechecking here (that's nupp.tools.lsp's own
