...
:host {
  ...
  --pg-background: var(--nuppdoc-code-background, #faf7e8);
  --pg-background-alt: var(--nuppdoc-background-alt, #f2eed8);
  --pg-border: var(--nuppdoc-playground-border, var(--nuppdoc-border, #9d8e5e));
  --pg-text: var(--nuppdoc-text, #173333);
  --pg-muted: var(--nuppdoc-text-muted, #626956);
  --pg-error: #cf222e;
  --pg-warning: #8c5f22;
  --pg-info: var(--nuppdoc-accent, #1b5670);
  --pg-syntax-keyword: color-mix(in srgb, var(--pg-accent) 62%, var(--pg-text));
  --pg-syntax-string: var(--pg-accent);
  --pg-syntax-comment: var(--pg-muted);
