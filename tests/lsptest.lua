...
function M.generatedMembersHaveEditorIdentityAndProvenance()
   ...
   local source = [[@derive(Debug, Default, JSON)
local record Model
    value: integer
end
...
return restored, why, codec, shown
   ...
   assertContains(hover, "Generated by `@derive(JSON)` for `Model`", "generated hover")
   assertContains(hover, "Plan fingerprint:", "generated hover fingerprint")
   local inspected = responseWithId(out, 11).result
   assert(inspected.generatedBy == "JSON" and inspected.generatedOwner == "Model",
      "inspect reports generated provenance")
   assert(inspected.generatedNamespace == "instance"
      and inspected.generatedPlanFingerprint,
   ...
   assertContains(static.fromJSON.documentation, "@derive(JSON)",
   ...
   assertContains(responseWithId(out, 19).error.message,
      "change or remove @derive(JSON)", "generated rename refusal")
