...
-- What LuaJIT 2.1 backported is written out, not lowered. This is the whole
-- reason a `?.` chain costs a branch instead of a closure call, so it is
-- asserted on the generated text rather than only on the behaviour.
