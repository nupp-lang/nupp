...
local capabilityResolution = capabilities.resolve("lua51")
local diagnostics = check.check(
    ...
    {strict = true, dialect = "lua51", _capabilityResolution = capabilityResolution,}
)
...
local code, generated = gen.generate(parsed, filename, nil, nil, "lua51")
assert(#generated == 0)
