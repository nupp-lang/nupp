...
function M.coverageReportRunsAndWritesBrowsableArtifacts()
    ...
    assert(index:find("data-route='file/src/nupp/compiler/gen.nupp'", 1, true),
    ...
    assert(index:find("<a data-route='dir/src/nupp/compiler' href='#dir/src/nupp/compiler'>compiler</a>", 1, true),
