...
function M.fragmentsBecomeAStoredCaseAwareGraph()
    ...
    test.equal(#observation.modules, 2)
    test.equal(observation.modules[1].name, "app.model")
    test.equal(observation.modules[2].name, "app.worker")
    test.equal(observation.modules[2].dependencies[1], "app.model")
    ...
    test.equal(#observation.suites[1].cases[1].roots, 3)
    ...
    test.equal(graph.moduleDependencies[2][1], 1)
