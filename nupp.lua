...
local RESOURCES = {
    ...
    {source = "src/nupp/data/random.nupp", output = "nupp/compiler/nupp/data/random.nupp"},
    ...
    {source = "src/nupp/data/json/init.nupp", output = "nupp/compiler/nupp/data/json/init.nupp"},
    {source = "src/nupp/data/json/internal/decode.nupp", output = "nupp/compiler/nupp/data/json/internal/decode.nupp",},
    {
        source = "src/nupp/data/json/internal/decoder/fused.nupp",
        output = "nupp/compiler/nupp/data/json/internal/decoder/fused.nupp",
    },
    {
        source = "src/nupp/data/json/internal/decoder/eager.nupp",
        output = "nupp/compiler/nupp/data/json/internal/decoder/eager.nupp",
    },
    {
        source = "src/nupp/data/json/internal/decoder/serde.nupp",
        output = "nupp/compiler/nupp/data/json/internal/decoder/serde.nupp",
    },
    ...
    {source = "src/nupp/data/internal/store.nupp", output = "nupp/compiler/nupp/data/internal/store.nupp"},
