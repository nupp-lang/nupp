...
local RESOURCES = {
   ...
   {source = "src/nupp/quant.nupp", output = "nupp/compiler/nupp/quant.nupp"},
   {source = "src/nupp/ml/init.nupp", output = "nupp/compiler/nupp/ml/init.nupp"},
   {source = "src/nupp/ml/safetensors.nupp", output = "nupp/compiler/nupp/ml/safetensors.nupp"},
   {source = "src/nupp/ml/tokenizer.nupp", output = "nupp/compiler/nupp/ml/tokenizer.nupp"},
   ...
   {
      source = "src/nupp/data/jsondecoder/serde.nupp",
      output = "nupp/compiler/nupp/data/jsondecoder/serde.nupp",
   },
   {
      source = "src/nupp/data/json/provider.nupp",
      output = "nupp/compiler/nupp/data/json/provider.nupp",
   },
   {
      source = "src/nupp/data/json/aot.nupp",
      output = "nupp/compiler/nupp/data/json/aot.nupp",
   },
   ...
   {
      source = "src/nupp/runtime/backend/browser.nupp",
      output = "nupp/compiler/nupp/runtime/backend/browser.nupp",
   },
   {
      source = "src/nupp/runtime/backend/portable.nupp",
      output = "nupp/compiler/nupp/runtime/backend/portable.nupp",
   },
   {
      source = "src/nupp/runtime/backend/wasm.nupp",
      output = "nupp/compiler/nupp/runtime/backend/wasm.nupp",
   },
   {
...
for _, resource in ipairs({
   ...
   RESOURCES[#RESOURCES + 1] = {
      source = resource,
      output = resource:gsub("^src/", "nupp/compiler/"),
   }
end
...
PLAYGROUND_COMPILER_RESOURCES[#PLAYGROUND_COMPILER_RESOURCES + 1] = {
   source = "build/playground/preludeimage.bin",
